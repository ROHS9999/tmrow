...
public class OWMRequest {
    ...
    /**
     * Creates an OpenWeatherMap API request for the specific location determined by
     * the LATITUDE and LONGITUDE
     * 
     * @param LATITUDE  A string representing the latitude of the location that we
     *                  want weather data
     * @param LONGITUDE A string representing the longitude of the location that we
     *                  want weather data
     */
    ...
    /**
     * Gets a set of WeatherData objects that contains the temperature, probability
     * of precipitation and dates obtained from the OpenWeatherMap API request
     * 
     * @return An ArrayList of WeatherData objects that contains the temperature,
     *         probability of precipitation and dates obtained from the
    ...
    /**
     * Creates an array of probability of precipitation values that are within the
     * time of visit of the user
     * 
     * @param now           A Calendar object with the date initialized equal to the
     *                      moment when the request of weather data to the
     *                      OpenWeatherMap API is done
     * @param availableTime A double representing the user available time for the
     *                      route in hours
     * @return An ArrayList of Doubles with all the values of probability of
     *         precipitation that are within the interval time of visit of the user
     */
