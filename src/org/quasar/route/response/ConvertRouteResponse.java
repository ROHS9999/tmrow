...
public class ConvertRouteResponse {
     ...
     * 
     * @param routeResponse A response to the recommendation request made by a user
     * @return A string which is a JSON representation of the RouteResponse
     *         parameter
     */
...
//		jsonObject.put("IMEI", routeResponse.getIMEI());
	...
	for (int i = 0; i < routeResponse.getRoute().getPois().size(); i++) {
	    ...
	    // Arrival time para n�o fazer confus�o com visitTime
...
//		System.out.println(myJson);
	...
	PointOfInterest poi2 = new PointOfInterest(1, "Praça", 38.3567, -9.456799, 80, 9, 18, "Viewpoint", 5, 7, 70);
