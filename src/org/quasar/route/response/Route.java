...
public class Route {
     ...
     * 
     * @param pois           The set of POIs and timestamps that a user will visit
     *                       during the route
     * @param line           The coordinates (longitude, latitude, elevation) which
     ...
     * @param origin         The coordinate (latitude, longitude) that represents
     *                       the local of departure of the route
     * @param destination    The coordinate (latitude, longitude) that represents
     *                       the local of arrival of the route
     * @param startTime      A data representation of the moment when the route trip
     *                       starts
     * @param endTime        A data representation of the moment when the route trip
     *                       starts
     * @param calories       An estimation of the total calories burned by a user
     *                       during the route trip
     */
    public Route(LinkedList<TimedPointOfInterest> pois, ArrayList<GHPoint3D> line, int time, double distance,
	    int sustainability, int price, GHPoint origin, GHPoint destination, Timestamp startTime, Timestamp endTime,
	    int calories) {
    ...
    /**
     * Gets a list containing the POIs associated with a timestamp which is the
     * moment the user should be visiting it
     * 
     * @return A linked list containing the set of POIs and timestamps that a user
     *         will visit during the route
     */
     ...
     * moment the user should be visiting it
     * 
     * @param pois A linked list containing the set of POIs and timestamps that a
     *             user will visit during the route
     */
    ...
    /**
     * Gets a list of coordinates (longitude, latitude, elevation) which the route
     * will pass through
     * 
     * @return An array list representing the coordinates (longitude, latitude,
     *         elevation) which the route will pass through
     */
    ...
    /**
     * Sets a list of coordinates (longitude, latitude, elevation) which the route
     * will pass through
     * 
     * @param line An array list representing the coordinates (longitude, latitude,
     *             elevation) which the route will pass through
     */
     ...
     * 
     * @param sustainability An integer representing the route average
    ...
    /**
     * Gets the coordinate (latitude, longitude) that represents the local of
     * departure of the route
     * 
     * @return A GHPoint representing the coordinate (latitude, longitude) that is
     *         the local of departure of the route
     */
     ...
     * 
     * @return A timestamp representing a data representation of the moment when the
     *         route trip starts, in a long format
     */
     ...
     * 
     * @return A timestamp representing a data representation of the moment when the
     *         route trip ends, in a long format
     */
    ...
    /**
     * Gets an estimation of the total calories burned by a user during the route
     * trip
     * 
     * @return An int representing an estimation of the total calories burned by a
     *         user during the route trip
     */
