...
/**
 * Represents a structure that relates a PointOfInterest and the time that a
 * user should visit it during the route
 * 
 * @author Rúben Beirão
...
public class TimedPointOfInterest {
    ...
    /**
     * Creates a TimedPointOfInterest with the specified PointOfInterest and
     * Timestamp
     * 
     * @param poi            The TimedPointOfInterest PointOfInterest
     * @param visitTimestamp The TimedPointOfInterest timestamp to visit the
     *                       PointOfInterest
     */
     ...
     * 
     * @return A point of interest representing the TimedPointOfInterest
     *         PointOfInterest
     */
     ...
     * 
     * @param poi A PointOfInterest containing the TimedPointOfInterest point of
     *            interest
     */
     ...
     * 
     * @param visitTimestamp A Timestamp containing the TimedPointOfInterest time to
     *                       visit the PointOfInterest
     */
