...
//	private LinkedList<Schedule> schedule = new LinkedList<>();
     ...
     * 
     * @param pointID        The unique identifier of the point of interest in the
     *                       database
     * @param name           The name of the point of interest
     * @param latitude       The latitude geographic coordinate of the point of
     *                       interest
     * @param longitude      The longitude geographic coordinate of the point of
     *                       interest
     ...
     * @param category       The category to which the point of interest is
     *                       associated to
     * @param price          The estimated price of ticket to visit the point of
     *                       interest
     * @param crowding       The crowding level of the point of interest
     * @param visit_time     The estimated time that takes to visit the point of
     *                       interest in minutes
     */
    ...
    /**
     * Gets the geographic coordinates (longitude and latitude) of the point of
     * interest
     * 
     * @return A GHPoint representing the geographic coordinates (longitude and
     ...
     * 
     * @return An int representing the unique identifier of the point of interest in
     *         the database
     */
     ...
     * 
     * @param pointID An int representing the unique identifier of the point of
...
//	}
     ...
     * 
     * @param visitTime An int representing the estimated time that takes to visit
     *                  the point of interest in minutes
     */
     ...
     * 
     * @return A double representing the latitude geographic coordinate of the point
     *         of interest
     */
     ...
     * 
     * @return A double representing the longitude geographic coordinate of the
     *         point of interest
     */
     ...
     * 
     * @param latitude A double representing the latitude geographic coordinate of
     ...
     * Gets the longitude geographic coordinate of the point of interest
     * 
     * @param longitude A double representing the longitude geographic coordinate of
     *                  the point of interest
     */
     ...
     * 
     * @param closeHour An int representing the closing hour of the point of
     *                  interest
     */
     ...
     * 
     * @return An int representing the estimated time that takes to visit the point
     ...
     * 
     * @return A double representing the estimated price of ticket to visit the
     *         point of interest
     */
     ...
     * 
     * @param price A double representing the estimated price of ticket to visit the
     *              point of interest
     */
