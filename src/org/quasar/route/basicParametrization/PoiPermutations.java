...
/**
 * This class allows to do permutations of a set of POIs in the same way we do
 * permutations in maths. Having any ordered sequence in hand with a number "n"
 * of distinct elements, any other sequence formed by the same "n" reordered
 * elements is called permutation. In this way, we can say that if A is a
 * permutation of B, then A and B are made up of the same elements, but ordered
 * differently.
 * 
 * @author Rúben Beirão
 ...
 *
 */
public abstract class PoiPermutations {
     ...
     */
    public static void enumerate(LinkedList<PointOfInterest> original, int originalSize, int nElementsInPermutation,
     ...
     * @param i An int to get the element of the list in that position and set
     *          another in that place
     * @param j An int to get the element of the list in that position and set
     *          another in that place
     */
