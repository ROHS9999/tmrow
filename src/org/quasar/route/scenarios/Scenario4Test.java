...
/**
 * In his last day in Lisbon, Dinis decides to visit the city by night, because
 * he wants a vision of Lisbon and its lights. startTime = 22:00 endTime = 01:00
 * He wants to departure right from the restaurant he just had dinner Origin
 * (Restaurant) = (38.709612, -9.142108) and does not want to spend more money.
 * Budget=0� The idea is to go for a walk passing through some viewpoints and
 * squares, SelectedCategories = (3,8) during the next three hours, until he
 * arrives the hostel. Destination (Hostel) = (38.710516, -9.136196)
 * 
 * @author Rúben Beirão
