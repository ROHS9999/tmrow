 ...
 * He specifically chooses 8 places to visit and eat: Nicolau Café, Nicola Café,
 * Casa Portuguesa do Pastel de Bacalhau, Café da Garagem, Martinho da Arcada,
 * Aura Lisboa, Tasquinha A Vaidosa, As Bifanas do Afonso, A Brasileira e o
 * Solar do Duque. He is asking the maximum number of POIs possible and do not
 * choose any preferred category because there is no space for suggestions. He
 * has a budget of 70€ to spend.
 * 
 * @author Rúben Beirão
