...
public class PoiPermutationsTest {
	...
	PointOfInterest poi3 = new PointOfInterest(3, "Tasquinha A Vaidosa", -9.13441912, 38.71695138, 20, 9, 22, 5,
		7.5, 6, 45);
	PointOfInterest poi4 = new PointOfInterest(4, "Palácio da Rosa", -9.1346331, 38.714776, 10, 0, 24, 7, 0, 3, 70);
	PointOfInterest poi5 = new PointOfInterest(5, "Pérola do Rossio", -9.13862817, 38.71356062, 10, 10, 19, 1, 0, 7,
		20);
